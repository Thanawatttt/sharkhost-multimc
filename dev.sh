...
case $n in
  1) 
    ...
    curl -L https://api.papermc.io/v2/projects/paper/versions/1.8.8/builds/445/downloads/paper-1.8.8-445.jar -o server.jar
  ...
  2) 
    ...
    curl -L https://cdn.discordapp.com/attachments/904385467359842345/947085463896870942/paper-server.jar -o server.jar
  ...
  3) 
    ...
    curl -L https://api.papermc.io/v2/projects/paper/versions/1.16.5/builds/794/downloads/paper-1.16.5-794.jar -o server.jar
  ...
  4)
    ...
    curl -L https://api.papermc.io/v2/projects/paper/versions/1.17.1/builds/411/downloads/paper-1.17.1-411.jar -o server.jar
  ...
  5) 
    ...
    curl -L https://api.papermc.io/v2/projects/paper/versions/1.18.2/builds/388/downloads/paper-1.18.2-388.jar -o server.jar
  ...
  7)
    ...
    curl -L https://api.papermc.io/v2/projects/paper/versions/1.19.2/builds/273/downloads/paper-1.19.2-273.jar -o server.jar
